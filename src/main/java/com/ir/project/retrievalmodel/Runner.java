...
public class Runner {
	...
	public static List<SearchQuery> fetchSearchQueries(String queryFilePath) throws IOException {
...
//		System.out.println(correctedQuery.toString());

		//        System.out.println(Noisyqueries.toString());
		//        try {
		//       Thread.sleep(3000);
		//    } catch (InterruptedException e) {
		...
		//       e.printStackTrace();
		//    }
		testRunTask1.run(Noisyqueries,RetrievalModelRun.NoStopNoStem, relevantQueryDocMap);
		...
		//        testRunTask3A.run(correctedQuery,RetrievalModelRun.WithStopNoStem,relevantQueryDocMap);
		//
		//        // Run 4,5,6:
		//
		...
		//        testRunTask3B.run(correctedQuery,RetrievalModelRun.NoStopWithStem,relevantQueryDocMap);
